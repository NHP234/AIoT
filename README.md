...
> Cảm biến gia tốc phát hiện di chuyển trái phép, kêu còi báo động tại chỗ và gửi thông báo tức thì qua Telegram.
...
- Phát hiện chuyển động và nghiêng bằng **MPU6050** (cảm biến rung SW-420 có thể tích hợp thêm ở phiên bản sau).
...
| Giao thức cảm biến | I2C (MPU6050) |
